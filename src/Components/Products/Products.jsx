        ...
        <div className="max-w-7xl mt-36 mx-auto md:mt-[450px]">
            ...
            <div className="mt-12 flex flex-col md:flex-row gap-6">
                <div className="w-11/12 mx-auto md:w-1/5 md:h-[556px] bg-white border border-solid border-[rgba(9,8,15,0.1)] rounded-2xl  flex flex-col items-center gap-6 py-6">
                    ...
                    }} className={`${active === 'one' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl  w-[192px] h-[52px] sora text-lg font-medium "`}>All Products</button>
                    <button onClick={() => {
                        setActive('two');
                    ...
                    } className={`${active === 'two' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl  w-[192px] h-[52px] sora text-lg font-medium "`}>Laptops</button>
                    <button onClick={() => {
                        setActive('three');
                    ...
                    } className={`${active === 'three' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl w-[192px] h-[52px] sora text-lg font-medium "`}>Phones</button>
                    <button onClick={() => {
                        setActive('four');
                    ...
                    } className={`${active === 'four' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl w-[192px] h-[52px] sora text-lg font-medium "`}>Accessories</button>
                    <button onClick={() => {
                        setActive('five');
                    ...
                    } className={`${active === 'five' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl w-[192px] h-[52px] sora text-lg font-medium "`}>Smart Watches</button>
                    <button onClick={() => {
                        setActive('six');
                        const filtered = allData.filter(each => each.category === 'MacBook');
                        setFilteredData(filtered);
                    }
                    } className={`${active === 'six' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl w-[192px] h-[52px] sora text-lg font-medium "`}>MacBook</button>
                    <button onClick={() => {
                        setActive('seven');
                    ...
                    } className={`${active === 'seven' ? 'bg-red-700 text-white' : 'bg-[rgba(9,8,15,0.05)] text-[rgba(9,8,15,0.6)]'} " rounded-2xl w-[192px] h-[52px] sora text-lg font-medium "`}>Iphone</button>
                </div>
                {
